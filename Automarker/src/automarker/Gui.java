...
/*  58 */         new Gui.MyWindowListener().windowClosing(null);
/*     */       }
/*     */     }
/*     */   }
/*     */
...
/*     */   {
/* 133 */     SelectAllListener(Gui param1) { this(); }
/*     */     public void focusLost(FocusEvent paramFocusEvent) {}
...
/*     */
/* 141 */   private class MyWindowListener extends java.awt.event.WindowAdapter {  
/*     */
/* 143 */     public void windowClosing(java.awt.event.WindowEvent paramWindowEvent) { 
/* 147 */         System.exit(0);
/*     */     }
/*     */
/*     */}
/* 152 */   private class MySymNameListener implements java.awt.event.ActionListener { 
/*     */
/* 154 */     public void actionPerformed(ActionEvent paramActionEvent) { Gui.this.input.requestFocus(); }
/*     */ }
/*     */
/* 158 */   private class MyInputListener implements java.awt.event.ActionListener { MyInputListener(Gui param1) { this(); }
/*     */
...
/*     */   }
/*     */
/* 222 */   private class FontListener implements Options.Listener { 
/*     */
...
/* 234*/    Options.getFontSizeOption().addListener(new FontListener());
/* 235*/     addWindowListener(new MyWindowListener());
...
/*     */   }
/*     */
/*     */   private JPanel makeInputPanel() {//places the define as panel
...
/*     */
/* 301 */     javax.swing.JLabel localJLabel2 = new javax.swing.JLabel("Enter an expression ( \\ = λ)");
