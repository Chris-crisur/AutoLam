...
/*    */   
/*  9 */   private static class EqualsVisitor implements Expr.VisitorP { 
...
/* 43 */   private static class HashCodeComputer implements Expr.Visitor { 
            HashCodeComputer() { }
...
/* 76 */       Integer localInteger = (Integer)this.expr.visit(new HashCodeComputer());
...
/* 88 */       return this.expr.visitP(new EqualsVisitor(), localExprWrapper.expr) == TRUE; }
