...
/*     */     }
/*     */
/* 141 */   private class MyWindowListener extends java.awt.event.WindowAdapter { MyWindowListener() { }
/*     */
...
/*     */      }
/*     */
/* 152 */   private class MySymNameListener implements java.awt.event.ActionListener { MySymNameListener() {}
/*     */
/* 154 */     public void actionPerformed(ActionEvent paramActionEvent) { Gui.this.input.requestFocus(); }
/*     */
/*     */      }
/*     */
/* 158 */   private class MyInputListener implements java.awt.event.ActionListener { MyInputListener() { }
/*     */
...
/*     */   }
/*     */
/* 222 */   private class FontListener implements Options.Listener { FontListener() { }
/*     */
...
/* 251 */     this.sym_name.addActionListener(new MySymNameListener());
/* 252 */     this.sym_name.addFocusListener(localMenuEdit);
/* 253 */     this.sym_name.addFocusListener(new SelectAllListener());
/*     */
/* 255 */     this.input = LambdaText.createTextField(30);
/* 256 */     this.input.setFont(localFont);
/* 257 */     this.input.addActionListener(new MyInputListener());
/* 258 */     this.input.addFocusListener(localMenuEdit);
/* 259 */     this.input.addFocusListener(new SelectAllListener());
/*     */
