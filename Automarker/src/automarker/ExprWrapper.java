...
/*    */   
/*  9 */   private static class EqualsVisitor implements Expr.VisitorP { EqualsVisitor(ExprWrapper param1) { this(); }
...
/* 43 */   private static class HashCodeComputer implements Expr.Visitor { HashCodeComputer(ExprWrapper param1) { this(); }
