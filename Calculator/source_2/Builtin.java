...
/*   6 */   private static abstract class BinaryOperator extends Builtin { BinaryOperator(Builtin.1 param1) { this(); }
/*     */     
...
/*  33 */   private static class AddOperator extends Builtin.BinaryOperator { private AddOperator() { super(); } AddOperator(Builtin.1 param1) { this(); }
/*  34 */     String computeResult(int paramInt1, int paramInt2) { return "" + (paramInt1 + paramInt2); } }
/*     */   
/*  36 */   private static class SubOperator extends Builtin.BinaryOperator { private SubOperator() { super(); } SubOperator(Builtin.1 param1) { this(); }
/*  37 */     String computeResult(int paramInt1, int paramInt2) { return "" + (paramInt1 - paramInt2); } }
/*     */   
/*  39 */   private static class MultOperator extends Builtin.BinaryOperator { private MultOperator() { super(); } MultOperator(Builtin.1 param1) { this(); }
/*  40 */     String computeResult(int paramInt1, int paramInt2) { return "" + paramInt1 * paramInt2; } }
/*     */   
/*  42 */   private static class DivOperator extends Builtin.BinaryOperator { private DivOperator() { super(); } DivOperator(Builtin.1 param1) { this(); }
/*  43 */     String computeResult(int paramInt1, int paramInt2) { return "" + paramInt1 / paramInt2; } }
/*     */   
/*  45 */   private static class EqOperator extends Builtin.BinaryOperator { private EqOperator() { super(); } EqOperator(Builtin.1 param1) { this(); }
/*  46 */     String computeResult(int paramInt1, int paramInt2) { return "" + (paramInt1 == paramInt2); } }
/*     */   
/*  48 */   private static class NeOperator extends Builtin.BinaryOperator { private NeOperator() { super(); } NeOperator(Builtin.1 param1) { this(); }
/*  49 */     String computeResult(int paramInt1, int paramInt2) { return "" + (paramInt1 != paramInt2); } }
/*     */   
/*  51 */   private static class LtOperator extends Builtin.BinaryOperator { private LtOperator() { super(); } LtOperator(Builtin.1 param1) { this(); }
/*  52 */     String computeResult(int paramInt1, int paramInt2) { return "" + (paramInt1 < paramInt2); } }
/*     */   
/*  54 */   private static class GtOperator extends Builtin.BinaryOperator { private GtOperator() { super(); } GtOperator(Builtin.1 param1) { this(); }
/*  55 */     String computeResult(int paramInt1, int paramInt2) { return "" + (paramInt1 > paramInt2); } }
/*     */   
/*  57 */   private static class LeOperator extends Builtin.BinaryOperator { private LeOperator() { super(); } LeOperator(Builtin.1 param1) { this(); }
/*  58 */     String computeResult(int paramInt1, int paramInt2) { return "" + (paramInt1 <= paramInt2); } }
/*     */   
/*  60 */   private static class GeOperator extends Builtin.BinaryOperator { private GeOperator() { super(); } GeOperator(Builtin.1 param1) { this(); }
/*  61 */     String computeResult(int paramInt1, int paramInt2) { return "" + (paramInt1 >= paramInt2); }
/*     */   }
/*     */   
/*  64 */   private static class IfOperator extends Builtin { IfOperator(Builtin.1 param1) { this(); }
/*     */     
